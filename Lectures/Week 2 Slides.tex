...
\begin{frame}{Difficulty Target Adjustment}
  ...
  % [FIGURE NEEDED: Bitcoin hashrate vs difficulty over time, source: Blockchain.com or Glassnode]
\begin{figure}
    \centering
...
\begin{frame}{The Transition to Fee-Based Security}
  ...
  % [FIGURE NEEDED: Bitcoin fees vs block reward over time, source: Blockchain.com]
...
%    \item \textbf{Optimistic Rollups}: Assume transactions valid; allow fraud proofs
%    \item \textbf{ZK-Rollups}: Use cryptographic proofs to guarantee validity
  \end{itemize}
...
\begin{frame}{Energy Consumption: The Updated Picture}
  ...
  \vspace{1em}
  % [FIGURE NEEDED: Updated energy comparison - Bitcoin vs Ethereum post-Merge vs countries/industries. Source: CCRI, Digiconomist, or Cambridge Bitcoin Electricity Consumption Index]
...
\end{figure}
  ...
  % \textbf{Bitcoin mining pools} (as of late 2024):
  % \begin{itemize}
  %   \item Top 4 pools control ~70\% of hashrate
  %   \item Foundry USA, AntPool, F2Pool, ViaBTC dominate
  %   \item Geographic concentration: US, China (despite ban), Kazakhstan
  % \end{itemize}
...
\begin{frame}{Wealth Concentration}
  ...
  \vspace{1em}
  % [FIGURE NEEDED: Bitcoin address distribution by holdings - Glassnode or BitInfoCharts]
